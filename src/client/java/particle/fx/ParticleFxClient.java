...
import particle.fx.discord.DiscordPresenceManager;
import particle.fx.particle.ParticleConfig;
...
public class ParticleFxClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		DiscordPresenceManager discordPresence = new DiscordPresenceManager();
		ParticleConfig.load(particles.getSettings());
		...
		ClientLifecycleEvents.CLIENT_STOPPING.register(client -> discordPresence.stop());
