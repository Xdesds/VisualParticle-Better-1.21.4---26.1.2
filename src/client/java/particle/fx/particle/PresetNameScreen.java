...
public class PresetNameScreen extends Screen {
	...
	public PresetNameScreen(Screen parent, String title, String buttonLabel, Consumer<String> onConfirm) {
	...
	protected void init() {
		...
		nameField = new TextFieldWidget(textRenderer, left, centerY, fieldWidth, 20, Text.literal("Preset Name"));
	...
	public void render(DrawContext context, int mouseX, int mouseY, float delta) {
		...
		context.drawTextWithShadow(textRenderer, Text.literal("Preset name"), width / 2 - 110, height / 2 - 34, 0xFFFFFF);
